      ...
      <div className="container-x relative">
        <Reveal className="mx-auto max-w-2xl text-center">
          ...
          <h2 className="mt-5 font-display text-3xl font-bold leading-tight text-slate-900 sm:text-5xl">
            Live Case Studies & <span className="text-gradient">Client Work</span>
          </h2>

          <p className="mt-4 text-base text-slate-600 sm:text-lg">
            Real websites engineered for ambitious growing brands. Explore our live builds — designed for speed, beauty, and lead generation.
          </p>
        </Reveal>
                  ...
                  <div className={`lg:col-span-7 ${isEven ? "" : "lg:order-2"}`}>
                    <div className="group relative overflow-hidden rounded-3xl border border-gray-200 bg-slate-100 shadow-xl transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl hover:shadow-blue-500/10">
                      <div className="relative aspect-[16/10] overflow-hidden">
                        ...
                        <span className="absolute left-5 top-5 rounded-full bg-blue-600/90 px-3.5 py-1.5 text-xs font-bold text-white shadow-md backdrop-blur-md">
                          {p.category}
                        </span>
                      </div>
                    </div>
                  ...
                  <div className={`lg:col-span-5 ${isEven ? "" : "lg:order-1"}`}>
                    ...
                    <div className="mt-8 flex flex-wrap items-center gap-4">
                      <a
                        ...
                        className="btn-primary inline-flex items-center gap-2 !py-3 text-xs"
                      >
